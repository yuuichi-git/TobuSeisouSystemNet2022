...
namespace Dao {
    public class CollectionWeightTaitouDao {
        ...
        /// <summary>
        /// SelectAllListCollectionWeightTaitou
        /// collection_weight_taitouをH_CollectionWeightTaitouに変換する為に使用する
        /// </summary>
        /// <returns></returns>
        public List<CollectionWeightTaitouVo> SelectAllListCollectionWeightTaitou() {
            List<CollectionWeightTaitouVo> listCollectionWeightTaitouVo = new List<CollectionWeightTaitouVo>();
            SqlCommand sqlCommand = _connectionVo.Connection.CreateCommand();
            sqlCommand.CommandText = "SELECT operation_date," +
                                            "weight_1_total," +
