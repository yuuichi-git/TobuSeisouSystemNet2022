        ...
        public List<LegalTwelveItemListVo> SelectLegalTwelveItemList(DateTime startDate, DateTime endDate, bool allTermFlag) {
            ...
            using(SqlDataReader sqlDataReader = sqlCommand.ExecuteReader()) {
                while(sqlDataReader.Read() == true) {
                    ...
                    legalTwelveItemListVo.BelongsName = _dictionaryBelongs[legalTwelveItemListVo.Belongs];
                    legalTwelveItemListVo.JobForm = _defaultValue.GetDefaultValue<int>(sqlDataReader["job_form_code"]);
                    legalTwelveItemListVo.JobFormName = _dictionaryJobForm[legalTwelveItemListVo.JobForm];
                    legalTwelveItemListVo.OccupationCode = _defaultValue.GetDefaultValue<int>(sqlDataReader["occupation_code"]);
                    legalTwelveItemListVo.OccupationName = _defaultValue.GetDefaultValue<string>(sqlDataReader["occupation_name"]);
                    legalTwelveItemListVo.StaffCode = _defaultValue.GetDefaultValue<int>(sqlDataReader["staff_code"]);
                    legalTwelveItemListVo.StaffName = _defaultValue.GetDefaultValue<string>(sqlDataReader["staff_name"]);
                    legalTwelveItemListVo.EmploymentDate = _defaultValue.GetDefaultValue<DateTime>(sqlDataReader["employment_date"]);
                    legalTwelveItemListVo.Students01Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_01_flag"]);
                    legalTwelveItemListVo.Students02Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_02_flag"]);
                    legalTwelveItemListVo.Students03Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_03_flag"]);
                    legalTwelveItemListVo.Students04Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_04_flag"]);
                    legalTwelveItemListVo.Students05Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_05_flag"]);
                    legalTwelveItemListVo.Students06Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_06_flag"]);
                    legalTwelveItemListVo.Students07Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_07_flag"]);
                    legalTwelveItemListVo.Students08Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_08_flag"]);
                    legalTwelveItemListVo.Students09Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_09_flag"]);
                    legalTwelveItemListVo.Students10Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_10_flag"]);
                    legalTwelveItemListVo.Students11Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_11_flag"]);
                    legalTwelveItemListVo.Students12Flag = _defaultValue.GetDefaultValue<bool>(sqlDataReader["students_12_flag"]);
