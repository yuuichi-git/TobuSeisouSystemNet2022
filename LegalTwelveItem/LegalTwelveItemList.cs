    ...
    public partial class LegalTwelveItemList : Form {
        ...
        private void ButtonUpdate_Click(object sender, EventArgs e) {
            ...
            foreach(LegalTwelveItemListVo legalTwelveItemFormVo in listLegalTwelveItemFormVo) {
                ...
                SheetViewList.Rows[i].ForeColor = legalTwelveItemFormVo.JobForm == 11 ? Color.Red : Color.Black; // 手帳のレコードのForeColorをセット
                ...
                SheetViewList.Cells[i, colStudentsFlag01].Text = legalTwelveItemFormVo.Students01Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag02].Text = legalTwelveItemFormVo.Students02Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag03].Text = legalTwelveItemFormVo.Students03Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag04].Text = legalTwelveItemFormVo.Students04Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag05].Text = legalTwelveItemFormVo.Students05Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag06].Text = legalTwelveItemFormVo.Students06Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag07].Text = legalTwelveItemFormVo.Students07Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag08].Text = legalTwelveItemFormVo.Students08Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag09].Text = legalTwelveItemFormVo.Students09Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag10].Text = legalTwelveItemFormVo.Students10Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag11].Text = legalTwelveItemFormVo.Students11Flag ? "〇" : "";
                SheetViewList.Cells[i, colStudentsFlag12].Text = legalTwelveItemFormVo.Students12Flag ? "〇" : "";
                i++;
            }
            // 先頭行（列）インデックスをセット
