...
namespace Common {
    public  class InitializeForm {
        ...
        public Form LegalTwelveItemList(Form form) {
            form.KeyPreview = true;
            form.MaximumSize = new Size(1200, 1080);
            form.MinimumSize = new Size(1200, 1048);
            GetWorkingArea(form);
            return form;
        }
        ...
        public Form SupplyList(Form form) {
            form.KeyPreview = true;
            form.MaximumSize = new Size(880, 1080);
            form.MinimumSize = new Size(880, 1048);
            GetWorkingArea(form);
            return form;
        }
        ...
        /// <param name="form"></param>
        /// <returns></returns>
        public Form SupplyDetail(Form form) {
            form.KeyPreview = true;
            form.MaximumSize = new Size(880, 1080);
            form.MinimumSize = new Size(880, 1048);
            GetWorkingArea(form);
