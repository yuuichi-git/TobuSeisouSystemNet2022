namespace TobuSeisouSystemNet2022 {
    partial class StartProject {
        ...
        private void InitializeComponent() {
            ...
            HPanelTop.Size = new Size(683, 136);
            ...
            label15.Location = new Point(40, 308);
            label15.Name = "label15";
            label15.Size = new Size(207, 17);
            label15.TabIndex = 33;
            label15.Text = "車両事故・作業事故等を記録します。";
            // 
            // label20
            // 
            label20.AutoSize = true;
            label20.Font = new Font("Yu Gothic UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            label20.Location = new Point(14, 292);
            label20.Name = "label20";
            label20.Size = new Size(73, 17);
            label20.TabIndex = 32;
            label20.Tag = "H_CarAccidentList";
            label20.Text = "事故記録簿";
            ...
            label18.Location = new Point(40, 268);
            label18.Name = "label18";
            label18.Size = new Size(185, 17);
            label18.TabIndex = 31;
            label18.Text = "年度内の講習記録を作成します。";
            // 
            // label19
            // 
            label19.AutoSize = true;
            label19.Font = new Font("Yu Gothic UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            label19.Location = new Point(14, 252);
            label19.Name = "label19";
            label19.Size = new Size(198, 17);
            label19.TabIndex = 30;
            label19.Tag = "H_LegalTwelveItemList";
            label19.Text = "法定１２項目記録簿(陸運局対応)";
            label19.Click += Label_Click;
            label19.MouseEnter += Label_MouseEnter;
            label19.MouseLeave += Label_MouseLeave;
            // 
            // label11
            // 
            ...
            label12.TabIndex = 28;
            label12.Tag = "H_CollectionWeightTAITOUDetail";
            label12.Text = "台東区配車人数集計表";
